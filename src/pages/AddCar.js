      ...
      <div className="w-full md:w-1/2 bg-white bg-opacity-90 p-8 rounded-lg shadow relative z-10">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="flex gap-4">
            <button type="submit" className="flex-1 bg-gradient-to-r from-gray-400 via-gray-600 to-black text-white py-2 rounded shadow hover:opacity-90 transition">Save</button>
            <button type="button" onClick={handleCancel} className="flex-1 bg-gradient-to-r from-gray-400 via-gray-600 to-black text-white py-2 rounded shadow hover:opacity-90 transition">Cancel</button>
          </div>
        </form>
      </div>
