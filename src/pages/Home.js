...
export default function Home({ cars = [] }) {
  ...
  return (
    <>
      ...
      {/* الخلفية تغطي الصفحة كلها */}
      <main className="min-h-screen w-full bg-gradient-to-b from-gray-200 to-gray-800 relative">
        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="relative mb-16 min-h-[600px]">
            ...
            <div className="absolute top-8 right-0 space-y-2 z-10">
          ...
          <div className="container mx-auto px-6 py-8">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right text-white">
                <p className="text-right">Mon-Fri: 8:00AM - 9:00PM</p>
              </div>
            </div>
